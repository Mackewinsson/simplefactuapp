---
title: Trabajos DEAD y disponibilidad
description: Qué hacer si un envío queda en estado DEAD, y sondas públicas /health y /ready.
---

## Si una factura queda en estado DEAD
...
3. Emite una factura nueva o rectificativa; no reutilices el mismo trabajo.
...
## Sondas públicas (integradores y operaciones)
...
| `GET /ready` | DB + migraciones + worker + cola — recomendada para comprobaciones de disponibilidad |
