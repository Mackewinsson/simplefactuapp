...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/docs/entornos`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/docs/quickstart`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/docs/envio-facturas`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/docs/cancelacion-facturas`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/docs/authentication`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/docs/verificar-nif`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/docs/registros`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/docs/webhooks`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/docs/plan-y-uso`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.5 },
    ...
    { url: `${base}/docs/changelog`, lastModified: staticLastMod, changeFrequency: "monthly", priority: 0.5 },
    ...
    { url: `${base}/integraciones`, lastModified: staticLastMod, changeFrequency: "weekly", priority: 0.95 },
    { url: `${base}/integraciones/factusol-verifactu`, lastModified: staticLastMod, changeFrequency: "weekly", priority: 0.95 },
    { url: `${base}/integraciones/contasimple-verifactu`, lastModified: staticLastMod, changeFrequency: "weekly", priority: 0.95 },
    { url: `${base}/integraciones/odoo-verifactu`, lastModified: staticLastMod, changeFrequency: "weekly", priority: 0.95 },
